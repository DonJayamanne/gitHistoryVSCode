...
class DiContainer implements IDiContainer {
    ...
    constructor() {
        ...
        cont.bind<LogViewer>(logViewerTYPES.LogViewer).to(LogViewer).inSingletonScope();
        cont.bind<IThemeService>(logViewerTYPES.IThemeService).to(ThemeService).inSingletonScope();
