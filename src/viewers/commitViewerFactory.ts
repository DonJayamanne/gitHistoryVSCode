...
export class CommitViewerFactory implements ICommitViewerFactory {
    ...
    public getCommitViewer(): ICommitViewer {
        ...
        return (this.commitViewer = new CommitViewer(
            this.outputChannel,
            this.commitFormatter,
            this.commandManager,
            new NodeBuilder(this.fileCommitFactory, this.standardNodeFactory, this.platformService),
            'commitViewProvider',
    ...
    public getCompareCommitViewer(): ICommitViewer {
        ...
        return (this.compareViewer = new CommitViewer(
            this.outputChannel,
            this.commitFormatter,
            this.commandManager,
            new NodeBuilder(this.fileCommitFactory, this.compareNodeFactory, this.platformService),
            'compareCommitViewProvider',
