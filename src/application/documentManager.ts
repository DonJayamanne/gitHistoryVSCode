...
export class DocumentManager implements IDocumentManager {
    ...
    public showTextDocument(document: TextDocument, column?: ViewColumn | undefined, preserveFocus?: boolean | undefined): Thenable<TextEditor>;
    public showTextDocument(document: TextDocument, options?: TextDocumentShowOptions | undefined): Thenable<TextEditor>;
