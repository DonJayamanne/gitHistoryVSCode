...
//     constructor(private workspaceRootPath: string, private gitCmdExecutor: IGitCommandExecutor,
//         private logParser: ILogParser, private isWindows: boolean = /^win/.test(process.platform)) {
//     }

//     public async  getGitRoot(): Promise<string> {
//         if (!this.gitRootPath) {
//             const gitRootPath = await this.gitCmdExecutor.exec(['rev-parse', '--show-toplevel'], this.workspaceRootPath);
...
//                     return;
//                 }
//                 return this.logParser.parse(entry, ITEM_ENTRY_SEPARATOR, STATS_SEPARATOR, LOG_FORMAT_ARGS);
//             })
...
//                     return undefined;
//                 }
//                 return this.logParser.parse(gitRepoPath, entry, gitRootPath, ITEM_ENTRY_SEPARATOR, STATS_SEPARATOR, LOG_FORMAT_ARGS, entriesWithFileModeChanges[index]);
//             })
