...
export default function Commit(props: CommitProps) {
  return (<div>
    ...
    <h1 className='commit-subject'>{props.result.subject}</h1>
    <Author result={props.result.author}></Author>
    <div className='commit-body'>{props.result.body}</div>
    <div className='commit-notes'>{props.result.notes}</div>
