...
export default class BrachGraph extends React.Component<BranchGrapProps> {
    componentWillReceiveProps(newProps: BranchGrapProps) {
        window.console.log('BranchGraph componentWillReceiveProps');
        window.console.log(this.svg);
        window.console.log(this.props.logEntries);
        window.console.log(this.props.height);
        window.console.log(this.props.itemHeight);
        window.console.log(this.props.width);

        window.console.log(newProps.logEntries);
        window.console.log(newProps.height);
        window.console.log(newProps.itemHeight);
        window.console.log(newProps.width);
    }
    componentWillUpdate(newProps: BranchGrapProps) {
        // debugger;
        // if (typeof newProps.itemHeight !== 'number') {
        //   return;
        // }

        // Black Magic
        window.console.log('BranchGraph componentWillUpdate');
        window.console.log(this.svg);
        window.console.log(this.props.logEntries);
        window.console.log(this.props.height);
        window.console.log(this.props.itemHeight);
        ...
        if (newProps.itemHeight <= 0 || newProps.logEntries.length === 0 ||
            (newProps.itemHeight === this.props.itemHeight && newProps.logEntries === this.props.logEntries)) {
            return;
        }
        let logView = jQuery('#log-view');
        // const $content = jQuery(this.svg.parentElement);
    ...
    // componentDidUpdate() {
    //   if (this.props.logEntries.length === 0 || !this.props.height || !this.props.width || !this.props.itemHeight) {
    //     return;
    //   }

    //   // Black Magic
    //   window.console.log('start rendering');
    // }
    ...
    render() {
        return (
            <svg ref={(ref) => this.svg = ref} xmlns='http://www.w3.org/2000/svg'></svg>
        );
    }
}
